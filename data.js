...
const ARTICLES = [
  ...
  /* ═══ PRENSA ═══ */
  {
    ...
    body: [
      ...
      { type: 'image', src: 'assets/images/conaf-cerrado.png', caption: 'Zona precordillerana de la Región Metropolitana. La capacidad de respuesta varía dramáticamente entre comunas.' },
      ...
      { type: 'paragraph', text: 'Esta entrevista abre una serie sobre gobernanza del acceso a la cordillera. Ver también <a href="article.html?id=sernatur-sin-mando-unico">la entrevista a SERNATUR</a>, <a href="article.html?id=mop-presupuesto-seguridad">al MOP</a> y <a href="article.html?id=mineduc-analfabetismo-montana">al Mineduc</a>.' }
    ]
  },

  {
    ...
    tag: 'Entrevista',
    body: [
      { type: 'paragraph', text: 'La Región Metropolitana posee uno de los patrimonios cordilleranos más imponentes del cono sur, sin embargo, su desarrollo turístico se encuentra en una paradoja institucional: mientras el flujo de visitantes aumenta, no existe una autoridad única con facultades para gestionar el territorio. En entrevista con el Servicio Nacional de Turismo (SERNATUR), las autoridades analizaron cómo la desigualdad presupuestaria entre municipios y la falta de "infraestructura habilitante" impiden transformar los recursos naturales en destinos turísticos seguros y sostenibles.' },
      { type: 'heading', text: 'Gestión del visitante: un vacío de mando' },
      { type: 'paragraph', text: 'Uno de los hallazgos más críticos del diagnóstico institucional es que, mientras los organismos técnicos como SENAPRED o SERNAGEOMIN operan bajo una cultura de <em>"riesgo cero"</em> para proteger la vida, no existe un ente encargado de gestionar al turista. Aunque SERNATUR pertenece al Ministerio de Economía, su poder es limitado: su trabajo se enfoca en promocionar el turismo y revisar los papeles de las empresas registradas, pero no tiene autoridad para decidir si una ruta se abre o se cierra.' },
      { type: 'quote', text: 'SERNATUR no debería estar liderando por sí las mesas, sino que nosotros damos el empujón y la entidad pertinente es la que debe tomar después el liderazgo. Cuando hablamos de seguridad, el delegado y el municipio deben tomar esa mesa bajo el alero de la Zona de Interés Turístico (ZOIT).', cite: 'Claudio Yáñez, Director Regional Metropolitano, SERNATUR' },
      { type: 'paragraph', text: 'Actualmente, las decisiones de cierre recaen en delegados presidenciales y alcaldes, que suelen actuar de forma reactiva ante informes técnicos de peligro, sin considerar el turismo seguro como variable de diseño.' },
      { type: 'heading', text: 'Desigualdad municipal' },
      { type: 'paragraph', text: 'El diagnóstico visibiliza una disparidad económica entre las dos comunas que concentran el turismo de montaña en Santiago. Mientras Lo Barnechea cuenta con un centro de montaña, máquinas quitanieves propias y recursos para comprar sal y mantener las rutas abiertas, San José de Maipo —la comuna más grande en kilómetros cuadrados de la región— opera con presupuestos mínimos.' },
      { type: 'image', src: 'assets/images/conaf-cerrado.png', caption: 'Cordón cordillerano de la Región Metropolitana. La capacidad de respuesta varía dramáticamente entre las comunas que lo administran.' },
      { type: 'quote', text: 'Lo Barnechea como municipio tiene mayor poder de gestión y recursos. San José de Maipo es uno de los municipios más pobres de la región y administrar ese territorio se torna sumamente difícil. Su oficina de turismo cuenta con una encargada y dos personas en informaciones; no tiene un equipo robusto de planificación o marketing.', cite: 'Claudio Yáñez, SERNATUR' },
      { type: 'paragraph', text: 'Esa brecha explica por qué, ante eventos climáticos similares, una comuna logra rehabilitar sus rutas en horas mientras la otra se ve obligada a cerrar sectores como el embalse El Yeso por semanas.' },
      { type: 'heading', text: 'Del "recurso" al "atractivo"' },
      { type: 'paragraph', text: 'Chile ha sido reconocido internacionalmente por su potencial para el turismo aventura, pero las autoridades advierten que tener un cerro o un glaciar no equivale a tener un destino turístico. Lugares como el embalse El Yeso sufren cierres constantes no solo por el clima, sino por la ausencia de baños, señalética y modelos de gestión de residuos.' },
      { type: 'paragraph', text: 'Esa brecha entre el potencial de la cordillera y la precaria infraestructura instalada obliga a SERNATUR a tomar medidas de contención. Ante la imposibilidad de administrar el territorio, las autoridades aplican una suerte de <em>autocensura</em> publicitaria para no generar emergencias al sobreexponer lugares que no están preparados.' },
      { type: 'quote', text: 'Desde nuestro rol principal, que es la promoción, somos bastante cuidadosos en no publicitar de sobremanera recursos turísticos que pudieran traer complicaciones por no tener la habilitación ni la infraestructura necesaria.', cite: 'Claudio Yáñez, SERNATUR' },
      { type: 'paragraph', text: 'Para revertir esa lógica, <strong>Luis Bravo Galdames</strong>, encargado de Desarrollo Territorial de SERNATUR RM, señala que la recientemente aprobada Zona de Interés Turístico (ZOIT) de San José de Maipo busca forzar la coordinación que hoy no existe.' },
      { type: 'quote', text: 'La ZOIT es como un proceso de evangelización en las distintas carteras para decir: tenemos que focalizar la inversión en turismo. No es que tengamos una billetera asegurada, sino que, según la ley, estos territorios son prioritarios para la ejecución de programas.', cite: 'Luis Bravo Galdames, Desarrollo Territorial, SERNATUR RM' },
      { type: 'heading', text: 'El "visitante santiaguino" como factor de colapso' },
      { type: 'paragraph', text: 'El diagnóstico apunta al comportamiento del público local como el principal disparador de las emergencias. A diferencia del turista internacional que contrata servicios certificados, el visitante que sube por el día desde Santiago suele hacerlo sin equipo ni conocimientos técnicos básicos —lo que SENAPRED ha denominado <em>"analfabetismo de montaña"</em>—.' },
      { type: 'quote', text: 'El visitante es el que causa mayor cantidad de problemas, no el turista. Lo que produce colapso es justamente el santiaguino que va por el día, sube y baja de la nieve sin el conocimiento ni el equipo adecuado.', cite: 'Claudio Yáñez, SERNATUR' },
      { type: 'paragraph', text: 'Esa presión masiva sobre un territorio sin infraestructura básica obliga a las autoridades a aplicar cierres preventivos totales para evitar tragedias, bloqueando incluso a los deportistas especializados y operadores formales.' },
      { type: 'paragraph', text: 'Conversando con las autoridades de SERNATUR, se evidencia que el diagnóstico sobre el turismo de montaña está condicionado por una falta de administración, donde ninguna autoridad asume la gestión directa del visitante en la cordillera. La fragilidad del sistema es el resultado de la ausencia de infraestructura habilitante sumada a una desigualdad presupuestaria que deja a los municipios más extensos sin capacidad de respuesta operativa.' },
      { type: 'paragraph', text: 'Esta entrevista es parte de una serie sobre gobernanza del acceso a la cordillera. Ver también <a href="article.html?id=senapred-analfabetismo-montana">la entrevista a SENAPRED</a>, <a href="article.html?id=mop-presupuesto-seguridad">al MOP</a> y <a href="article.html?id=mineduc-analfabetismo-montana">al Mineduc</a>.' }
    ]
  },

  {
    ...
    body: [
      ...
      { type: 'image', src: 'assets/images/Derrumbes-embalse.png', caption: 'Ruta de alta montaña en temporada invernal. La ingeniería cordillerana compite por fondos bajo criterio de "rentabilidad social".' },
      ...
      { type: 'paragraph', text: 'Esta entrevista es parte de una serie sobre gobernanza del acceso a la cordillera. Ver también <a href="article.html?id=senapred-analfabetismo-montana">la entrevista a SENAPRED</a>, <a href="article.html?id=sernatur-sin-mando-unico">a SERNATUR</a> y <a href="article.html?id=mineduc-analfabetismo-montana">al Mineduc</a>.' }
    ]
  },

  {
    ...
    body: [
      ...
      { type: 'paragraph', text: 'Esta entrevista cierra la serie sobre gobernanza del acceso a la cordillera. Ver también <a href="article.html?id=senapred-analfabetismo-montana">la entrevista a SENAPRED</a>, <a href="article.html?id=sernatur-sin-mando-unico">a SERNATUR</a> y <a href="article.html?id=mop-presupuesto-seguridad">al MOP</a>.' }
    ]
  },
...

  {
    ...
    category: 'analisis',
    title: 'Gobernanza de montaña: el vacío institucional de la cordillera chilena',
    ...
    tag: 'Opinión',
    body: [
      { type: 'paragraph', text: 'La discusión sobre la cordillera en Chile suele aparecer en momentos de conflicto: cierres preventivos, congestión vehicular, rescates, restricciones de acceso o disputas entre privados y visitantes. Sin embargo, detrás de esos episodios existe una pregunta más amplia sobre cómo el país administra uno de sus principales territorios geográficos.' },
      { type: 'paragraph', text: 'A diferencia del borde costero —donde el Estado desarrolló progresivamente instituciones, infraestructura y criterios relativamente claros para ordenar el uso humano— la montaña nunca consolidó una estructura equivalente. Hoy la cordillera concentra actividades productivas, infraestructura crítica, turismo, deporte, conservación y recreación, pero sin una gobernanza integrada sobre cómo conviven esos usos.' },
      { type: 'heading', text: 'La fragmentación institucional' },
      { type: 'paragraph', text: 'La minería tiene regulación específica. El agua también. Lo mismo ocurre con la energía, los embalses, la vialidad o las áreas protegidas. Cada una de esas actividades opera con organismos, procedimientos y atribuciones relativamente definidos.' },
      { type: 'paragraph', text: 'El uso humano no productivo de la montaña funciona distinto.' },
      { type: 'paragraph', text: 'Los accesos cordilleranos terminan administrados por una combinación variable entre municipios, ministerios, organismos técnicos, privados, autoridades de emergencia y operadores turísticos. Dependiendo del territorio, predominan criterios de seguridad, conservación, presión vehicular, capacidad operativa o propiedad privada.' },
      { type: 'paragraph', text: 'El resultado es una administración fragmentada, donde distintos actores intervienen sobre el mismo espacio desde lógicas completamente distintas.' },
      { type: 'paragraph', text: 'Mientras algunos sectores entienden la cordillera como infraestructura estratégica o reserva ambiental, otros la observan como espacio deportivo, turístico o recreativo. En la práctica, todas esas dimensiones conviven simultáneamente.' },
      { type: 'heading', text: 'Turismo, ciudadanía y externalidades' },
      { type: 'paragraph', text: 'Parte importante de la complejidad actual proviene del aumento sostenido de visitantes hacia zonas de montaña. Caminos originalmente diseñados para conectividad local o infraestructura energética comenzaron a absorber flujos recreativos cada vez mayores, especialmente en zonas cercanas a Santiago.' },
      { type: 'paragraph', text: 'Sin embargo, el uso de montaña no responde únicamente a una lógica turística tradicional.' },
      { type: 'paragraph', text: 'Existe un visitante que consume servicios formales —alojamiento, gastronomía, transporte o actividades guiadas— pero también un usuario que utiliza la cordillera como espacio cotidiano de recreación: deportistas, excursionistas, ciclistas, escaladores o visitantes por el día.' },
      { type: 'paragraph', text: 'Ambos generan presión territorial, aunque de formas distintas.' },
      { type: 'paragraph', text: 'Congestión vehicular, basura, erosión, rescates, estacionamientos saturados y presión sobre infraestructura pública son parte de las externalidades que comenzaron a tensionar a municipios, organismos técnicos y comunidades locales.' },
      { type: 'paragraph', text: 'Actualmente, distintos servicios públicos abordan partes del problema. Mientras algunos promueven el turismo o mantienen infraestructura vial, otros coordinan emergencias o fiscalizan determinados sectores. Sin embargo, no existe una institucionalidad específica encargada de coordinar integralmente la experiencia de montaña.' },
      { type: 'heading', text: 'Más allá de los accesos' },
      { type: 'paragraph', text: 'La discusión sobre gobernanza de montaña no se limita únicamente a abrir o cerrar caminos. También involucra capacidad de carga, planificación territorial, gestión del riesgo, conservación, conectividad e información pública.' },
      { type: 'paragraph', text: 'En los últimos años han surgido distintas iniciativas de coordinación territorial, mesas público-privadas y programas asociados al desarrollo turístico de montaña. Aun así, gran parte de esas estructuras operan con capacidades limitadas y sin atribuciones directas sobre el territorio.' },
      { type: 'paragraph', text: 'El debate de fondo parece apuntar hacia otro lugar: cómo un país organiza institucionalmente su relación con la cordillera.' },
      { type: 'paragraph', text: 'Chile desarrolló instituciones para ordenar su relación con el mar. La discusión pendiente es si la cordillera seguirá funcionando como una suma de usos sectoriales débilmente coordinados o si el país comenzará a entenderla como un territorio estratégico con una lógica territorial propia.' }
    ]
  }
